...
APP=qemu-full
BIN="qemu"
DEPENDENCES="ca-certificates jack2"
...
function _add_launcher_and_icon() {
	...
	cp -r "$LAUNCHER" ./
	echo "Categories=System;" >> ./*.desktop
